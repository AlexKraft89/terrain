...
World = function(){
	...
	this.planes = [];
	 ...
	 this.save.model = function(object){
	 	...
	 	model.file = object.modelfilename;
	 	model.path = object.modelfilepath;
	 	model.modelfilepath = object.modelfilepath;
	 	model.modelfilename = object.modelfilename;
		...
		$.post('/php/script/save.php',{'action':'Savemodel',
										...
										'x':model.position.x,
										'z':model.position.z,
										'file':model.modelfilepath + model.modelfilename
									}
										,function(response){});
