loader = function(window,undefined){
	...
	this.loadGeometru = function(data){
		...
		// for (d in data.option){
		// 	geometry[d] = data.option[d];
		// }
		// var gl = data.geometry.vertices.length;
		// while(gl--){
		// 	geometry.vertices[gl].x =  data.geometry.vertices.x;
		// 	geometry.vertices[gl].y =  data.geometry.vertices.y;
		// 	geometry.vertices[gl].z =  data.geometry.vertices.z;
		// }
	...
	this.loadterrian = function(data){
		...
		while(l--){
			...
			mesh.rotation.x = terra.G.rotation.x;
			mesh.rotation.y = terra.G.rotation.y;
			mesh.rotation.z = terra.G.rotation.z;
